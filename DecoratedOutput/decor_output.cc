...
void DecorOutput::render_output(const char& corner, const char& mid, const char& ends)
{
	// First line
...
// Set Decoration Type
int DecorOutput::SetType(const uint& Type)
{
...
//
DecorOutput::DecorOutput(const uint& Type, const uint& width)
{
	this->width = width;
	this->decor_type = Type;
}

DecorOutput::DecorOutput(string const& String, const uint& Type, const uint& width)
{
	this->width = width;
	this->decor_type = Type;
	this->StringContainer.push_back(String);
